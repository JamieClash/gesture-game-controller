class GestureState:
    def __init__(self, profile):
        # rel_gain=25, pan_speed=50, angle_gain=1600 <-- minecraft
        ...
        self.rel_gain = profile["mouse_settings"]["relative_gain"]
        ...
        self.panning_max_speed = profile["mouse_settings"]["pan_speed"]
        ...
        self.angle_gain = profile["mouse_settings"]["angle_gain"]
    
    def reset_deltas(self, index):
        self.prev_dxs[index] = 0
        self.prev_dys[index] = 0
    
    def update_state(self, new_profile):
        self.rel_gain = new_profile["mouse_settings"]["relative_gain"]
        self.panning_max_speed = new_profile["mouse_settings"]["pan_speed"]
        self.angle_gain = new_profile["mouse_settings"]["angle_gain"]
